...
@Repository
public class FilesDetailsDAO implements FileDetailsDAOInterface {

	private static final Logger logger = LoggerFactory.getLogger(FilesDetailsDAO.class);
	...
	public FilesDetailsDAO() {
	}

	public FilesDetailsDAO(JdbcTemplate jdbcTemplate) {
